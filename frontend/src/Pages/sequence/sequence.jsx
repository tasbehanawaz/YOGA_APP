...
const Sequence = () => {
  ...
  const handleTimeConstrainedVideo = () => {
    if (selectedPoses.length > 0) {
      ...
      navigate('/generate', {
        state: {
          selectedPoses: newVideo.selectedPoses,
          duration,
          url_png: newVideo.imageUrl,
        },
      });
    } else {
        ...
        <>
          ...
          <div className="fixed-sidebar p-6">
            ...
            <div className="filter-inputs space-y-4">
              ...
              <Button
                className="text-white hover:bg-green-600 w-full mt-4"
                onClick={handleTimeConstrainedVideo}
              >
                Generate Time Constrained Pose
              </Button>
            </div>
          </div>
        </>
