...
export function FooterWithSitemap() {
  return (
    <footer className="relative w-full">
      <div className="mx-auto w-full max-w-7xl px-8 flex-auto">
        <div className="mx-auto grid w-full grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-3 justify-center">
        ...
        <div className="flex w-full flex-col items-center justify-center py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear}{' '}
            <a href="https://github.com/tasbehanawaz/YOGA_APP">Yoga App</a>. All
            Rights Reserved.
          </Typography>
