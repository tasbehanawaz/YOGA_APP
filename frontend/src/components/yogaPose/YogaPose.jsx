...
const YogaPose = () => {
    ...
    const fetchPose = async () => {
        try {
            const response = await axios.get(`http://localhost:8001/backend/FetchYogaPoses.php?poseName=${poseName}`);
    ...
    const savePose = async () => {
        try {
            const response = await axios.post('http://localhost:8001/backend/save_yoga_pose.php', newPose);
